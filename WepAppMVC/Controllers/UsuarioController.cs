...
namespace WepAppMVC.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public JsonResult Logear(string usuario, string password)
        {
            ...
            //{
            //    if (usuarioBC.VerificarEstado(txtUsuario) == 1)
            //    {
            //        if (usuarioBC.ValidarLogin(txtUsuario, password) == true)
            //        {
            //            if (usuarioBC.VerificarPasswordNuevo(txtUsuario).Equals("123456"))
            //            {
            ...
            //                if (usuarioBC.VerificarRol(txtUsuario) == 1)
            //                {
            //                    mensaje = "<script language='javascript' type='text/javascript'>" +
            //                                                 "window.location.href=" +
            ...
            //        else
            //        {
            //            usuarioBC.ActualizarIntenosSumar(txtUsuario);
            //            mensaje = "<script language='javascript' type='text/javascript'>" +
            //                                 "alert('PASSWORD INCORRECTO!');window.location.href=" +
            //                                  "'/Usuario/Inicio';</script>";
            //            if (usuarioBC.VerificarIntentos(txtUsuario) >= 3)
            //            {
            //                usuarioBC.ActualizarEstado(txtUsuario, 0);
            //            }
            //        }
            //    }
            //    else
            //    {
            //        mensaje = "<script language='javascript' type='text/javascript'>" +
            //                                  "alert('ESTADO DE USUARIO BLOQUEADO! CONSULTE CON SU ADMINISTRADOR');window.location.href=" +
            //                                   "'/Usuario/Inicio';</script>";
            //    }
            //}
            //else 
